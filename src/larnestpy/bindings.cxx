...
PYBIND11_MODULE(larnestpy, m) 
{
	...
	// dEdx Parameters
	py::class_<larnest::LArdEdxParameters>(m, "LArdEdxParameters", py::dynamic_attr())
		.def(py::init<>())
		.def_readwrite("A", &larnest::LArdEdxParameters::A)
		.def_readwrite("kb", &larnest::LArdEdxParameters::kb)
		.def_readwrite("c", &larnest::LArdEdxParameters::c);
	...
	py::class_<larnest::LArNEST, std::unique_ptr<larnest::LArNEST, py::nodelete>>(m, "LArNEST")
		...
		.def("get_dedx_parameters", &larnest::LArNEST::GetdEdxParameters)
		.def("get_box_parameters", &larnest::LArNEST::GetBOXParameters)
		.def("get_birks_parameters", &larnest::LArNEST::GetBIRKSParameters)
		...
		.def("set_fano_er", &larnest::LArNEST::SetFanoER)
		.def("set_nex_over_nion", &larnest::LArNEST::SetNexOverNion)
		.def("set_nr_yields_parameters", &larnest::LArNEST::SetNRYieldsParameters)
		.def("set_er_yields_parameters", &larnest::LArNEST::SetERYieldsParameters)
		.def("set_er_electron_yields_alpha_parameters", &larnest::LArNEST::SetERElectronYieldsAlphaParameters)
		.def("set_er_electron_yields_beta_parameters", &larnest::LArNEST::SetERElectronYieldsBetaParameters)
		.def("set_er_electron_yields_gamma_parameters", &larnest::LArNEST::SetERElectronYieldsGammaParameters)
		.def("set_er_electron_yields_doke_birks_parameters", &larnest::LArNEST::SetERElectronYieldsDokeBirksParameters)
		.def("set_thomas_imel_parameters", &larnest::LArNEST::SetThomasImelParameters)
		.def("set_dedx_parameters", &larnest::LArNEST::SetdEdxParameters)
		.def("set_box_parameters", &larnest::LArNEST::SetBOXParameters)
		.def("set_birks_parameters", &larnest::LArNEST::SetBIRKSParameters)
		.def("set_drift_parameters", &larnest::LArNEST::SetDriftParameters)
